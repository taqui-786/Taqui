...
import { NextjsIcon, PostgresqlIcon, ReactIcon, ReactQueryIcon, TypescriptIcon } from './customIcons'
...
function HeroBio() {
  return (
       <div className=" flex flex-wrap items-center gap-x-1.5 gap-y-2 text-base md:text-lg text-neutral-500 whitespace-pre-wrap">
          ...
          <b className="text-black dark:text-white">users</b> actually enjoy
          using.
        </div>
  )
}
